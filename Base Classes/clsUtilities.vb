...
#Region "Get combo Text value"
    Public Function getcomboboxvalue(ByVal aform As SAPbouiCOM.Form, ByVal UID As String) As String
        Dim objEdit As SAPbouiCOM.ComboBox
        objEdit = aform.Items.Item(UID).Specific


        Return objEdit.Value
    End Function
    Public Sub setcomboxvalue(ByVal aform As SAPbouiCOM.Form, ByVal UID As String, ByVal newvalue As String)
        Dim objEdit As SAPbouiCOM.ComboBox
        objEdit = aform.Items.Item(UID).Specific
