Public Class clsReserveInvoice
    Inherits clsBase
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_ReserveInvoice Then
                        ...
                        Select Case pVal.EventType
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_ITEM_PRESSED
                                ...
                                If pVal.ItemUID = "1" And (oForm.Mode = SAPbouiCOM.BoFormMode.fm_UPDATE_MODE Or oForm.Mode = SAPbouiCOM.BoFormMode.fm_ADD_MODE) Then
                                    ...
                                    Dim oForm2 As SAPbouiCOM.Form = oApplication.SBO_Application.Forms.GetForm("-60091", 0)
                                    oForm = oApplication.SBO_Application.Forms.Item(FormUID)
