Public Module modVariables
    ...
    Public blnBatchMessage As Boolean = False
    Public oProHash As Hashtable
    ...
    Public Const frm_sales As String = "frm_Sales"
    Public Const xml_sales As String = "xml_SalesOrder.xml"
    Public Const mnu_sales As String = "Z_mnu_PR007"

    Public Const frm_Type As String = "frm_Type"
    Public Const xml_Type As String = "frm_Type.xml"
    Public Const mnu_Type As String = "Z_mnu_PR006"


    Public Const frm_Delivery As String = "frm_Delivery"
    Public Const xml_Delivery As String = "frm_Delivery.xml"
    Public Const mnu_Delivery As String = "Z_mnu_PR008"

    Public Const frm_Delivery2 As String = "frm_Delivery2"
    Public Const xml_Delivery2 As String = "frm_Delivery2.xml"
    Public Const mnu_Delivery2 As String = "Z_mnu_PR009"
    Public flagBatchsetup As Boolean = True
    ...
    Public Const mnu_salesorder As String = "2050"
    ...
    Public Const frm_Issue_For_Production As String = "65213"
    Public Const frm_batch_number_selection As String = "42"
    Public Const frm_batch_setup As String = "41"
    Public Const frm_Issue_Inventory As String = "720"
    ...
    Public Const frm_ReserveInvoice As String = "60091"
    Public Const frm_DeliverySystem As String = "140"
